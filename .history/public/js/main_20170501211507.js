   ...
   $scope.sub= function(){
     console.log($scope.this.this.zipcode);
      ...
      console.log(data);
       ...
       $http.get("https://www.zillow.com/webservice/GetRegionChildren.htm?zws-id=X1-ZWz19821g6hgqz_3s95g&state=NC&city=charlotte&childtype=neighborhood").then(function(response)
          { 
