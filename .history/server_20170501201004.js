...
app.post('/search/:data', function(req, res) {
  ...
  var queryURL = "http://www.zillow.com/webservice/GetRegionChildren.htm?zws-id=X1-ZWz19821g6hgqz_3s95g&state=NC&city=charlotte&childtype=neighborhood";
$.ajax({
          url: queryURL,
          method: "GET"
        }).done(function(response) {
    res.sendFile(__dirname + "/public/partials/search.html");
});
